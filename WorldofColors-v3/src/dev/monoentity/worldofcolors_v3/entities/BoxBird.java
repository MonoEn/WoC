...
public class BoxBird extends Moving {
	...
	public BoxBird(Handy hand, float x, float y) {
		super(hand, x, y, Assets.TILESIZE);
		animLeft = new Animations(500, Assets.birdLeft);
		currentSprite = Assets.birdLeft[0];
